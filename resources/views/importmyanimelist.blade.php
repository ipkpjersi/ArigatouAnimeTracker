<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Import MyAnimeList Export File
        </h2>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 flex flex-wrap">
                    <div class="w-full md:w-3/5 mt-0">
                        <h4 class="font-bold mb-2">Import Anime Export from MyAnimeList:</h4>
                        <form action="{{ route('import.myanimelistdata') }}" method="post" enctype="multipart/form-data">
                            @csrf
