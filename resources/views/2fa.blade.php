                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <strong>
                        <ol class="list-decimal ml-6">
                            <li>Click on Generate Secret. This will generate a unique secret QR code for you to scan.</li>
                    ...
                    {{--If we've never set up 2fa before--}}
                    ...
                    {{--If we've clicked to enable it/generate it but haven't done so yet--}}
                    @elseif($data['user']->passwordSecurity->google2fa_enable == null)
                        ...
                        <br/><br/>
                    {{--If we have it enabled and in use--}}
