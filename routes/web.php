...
Route::get('/seasonal/{view?}', [AnimeController::class, 'category'])
    ->name('anime.seasonal')
    ->defaults('category', 'seasonal')
    ->middleware('2fa');
...
Route::middleware('auth', '2fa')->group(function () {
    ...
    Route::post('/animelist/{username}/reorder', [AnimeController::class, 'reorderUserAnimeList'])->name('user.anime.reorder');
